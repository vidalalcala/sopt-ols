...
soptols.o: soptols.cpp soptols.h makefile
	g++ -std=c++11 -c soptols.cpp -framework accelerate
...
sopt_olsTestQuadratic: soptolsTestQuadratic.o seqols.o stochasticTools.o soptols.o
	g++ -std=c++11 -o sopt_olsTestQuadratic soptolsTestQuadratic.o seqols.o stochasticTools.o soptols.o -framework accelerate
